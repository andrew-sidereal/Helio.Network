...
namespace Lidgren.Network
{
	...
	public partial class NetBuffer
	{
        ...
        {
            int remainingBitCount = this.m_bitLength - this.m_readPosition;
            int remainingByteCount = (int)Math.Ceiling( remainingBitCount / 8.0f );
            return this.ReadBytes(remainingByteCount);
        }
